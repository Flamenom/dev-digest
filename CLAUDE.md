...
- **`specs/2026-08-27-pr-brief.md`** — when touching PR Brief (POST /pulls/:id/brief, brief cache, PrBriefCard on Overview, Risk Areas in IntentCard, Review Focus block).
