...
export class Container {
  ...
  /**
   * L02 — narrow cross-module access to skills (run-executor resolves an
   * agent's linked skills via `resolveAgentSkills(agentId)` here rather than
   * importing the skills module's folder).
   */
