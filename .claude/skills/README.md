...
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | UI code organization: where code lives, feature-vs-type, component splitting, App Router colocation |
...
| [pr-self-review](pr-self-review/SKILL.md) | Full-stack | Pre-PR gate: routes the diff to the skills above, verifies criticals, blocks `git push`/`gh pr create` on fail |
