...
/* ---- Agent ↔ skill links (L02 Skills tab) ------------------------------- */

/** Workspace skill list for the editor's Skills tab.
 *  Canonical skills hooks live in `hooks/skills.ts`; this duplicate exists only to
 *  keep the two hook files disjoint — the query key is intentionally shared. */
...
/** Ordered skill links for one agent. */
...
/** Replace the agent's linked skills with the FULL ordered set (link/unlink/reorder). */
